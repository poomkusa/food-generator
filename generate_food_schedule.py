...
def parse_arguments():
    ...
    parser.add_argument('--start_date', type=str, help='Start date in YYYY-MM-DD format.', default='2024-11-19')
    parser.add_argument('--num_days', type=int, help='Number of days for the schedule.', default=60)
